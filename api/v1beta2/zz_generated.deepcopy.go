...
func (in *CloudStackClusterStatus) DeepCopyInto(out *CloudStackClusterStatus) {
	*out = *in
	if in.CloudStackFailureDomainStatusMap != nil {
		in, out := &in.CloudStackFailureDomainStatusMap, &out.CloudStackFailureDomainStatusMap
		*out = make(CloudStackFailureDomainStatusMap, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in CloudStackFailureDomainStatusMap) DeepCopyInto(out *CloudStackFailureDomainStatusMap) {
	{
		in := &in
		*out = make(CloudStackFailureDomainStatusMap, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CloudStackFailureDomainStatusMap.
func (in CloudStackFailureDomainStatusMap) DeepCopy() CloudStackFailureDomainStatusMap {
	if in == nil {
		return nil
	}
	out := new(CloudStackFailureDomainStatusMap)
	in.DeepCopyInto(out)
	return *out
}
