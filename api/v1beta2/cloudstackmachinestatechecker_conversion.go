...
func (src *CloudStackMachineStateChecker) ConvertTo(dstRaw conversion.Hub) error { // nolint
	...
	return Convert_v1beta2_CloudStackMachineStateChecker_To_v1beta4_CloudStackMachineStateChecker(src, dst, nil)
}
...
func (dst *CloudStackMachineStateChecker) ConvertFrom(srcRaw conversion.Hub) error { // nolint
	...
	return Convert_v1beta4_CloudStackMachineStateChecker_To_v1beta2_CloudStackMachineStateChecker(src, dst, nil)
}
