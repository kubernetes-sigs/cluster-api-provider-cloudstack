...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CloudStackISOAttachment) DeepCopyInto(out *CloudStackISOAttachment) {
	*out = *in
	out.CloudStackResourceIdentifier = in.CloudStackResourceIdentifier
	if in.PreKubeadmCommandArgs != nil {
		in, out := &in.PreKubeadmCommandArgs, &out.PreKubeadmCommandArgs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.PostKubeadmCommandArgs != nil {
		in, out := &in.PostKubeadmCommandArgs, &out.PostKubeadmCommandArgs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CloudStackISOAttachment.
func (in *CloudStackISOAttachment) DeepCopy() *CloudStackISOAttachment {
	if in == nil {
		return nil
	}
	out := new(CloudStackISOAttachment)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CloudStackMachineSpec) DeepCopyInto(out *CloudStackMachineSpec) {
	*out = *in
	...
	in.ISOAttachment.DeepCopyInto(&out.ISOAttachment)
	if in.Details != nil {
