...
// Source: gitlab.aws.dev/ce-pike/merida/cluster-api-provider-capc/pkg/cloud (interfaces: Client)
...
import (
	...
	v1alpha4 "gitlab.aws.dev/ce-pike/merida/cluster-api-provider-capc/api/v1alpha4"
...
func (m *MockClient) AssignVMToLoadBalancerRule(arg0 *v1alpha4.CloudStackCluster, arg1 string) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) DestroyVMInstance(arg0 *v1alpha4.CloudStackMachine) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetOrCreateCluster(arg0 *v1alpha4.CloudStackCluster) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetOrCreateLoadBalancerRule(arg0 *v1alpha4.CloudStackCluster) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetOrCreateNetwork(arg0 *v1alpha4.CloudStackCluster) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetOrCreateVMInstance(arg0 *v1alpha4.CloudStackMachine, arg1 *v1alpha40.Machine, arg2 *v1alpha4.CloudStackCluster, arg3 string) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) OpenFirewallRules(arg0 *v1alpha4.CloudStackCluster) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) ResolveLoadBalancerRuleDetails(arg0 *v1alpha4.CloudStackCluster) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) ResolveNetwork(arg0 *v1alpha4.CloudStackCluster) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) ResolvePublicIPDetails(arg0 *v1alpha4.CloudStackCluster) (*cloudstack.PublicIpAddress, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) ResolveVMInstanceDetails(arg0 *v1alpha4.CloudStackMachine) error {
	m.ctrl.T.Helper()
