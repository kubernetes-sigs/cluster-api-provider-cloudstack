...
### This release extends the v0.4.4 release of CAPC with:
  ...
  * Bug fixes related to machine deletion (use of finalizers in all cases)
  * Bug fixes related to Affinity Group creation (host affinity established when anti-affinity requested)
...
* cluster-api-provider-cloudstack-v0.4.5.tar.gz: container image of the CAPC controller
* shasum.txt containing checksum for the released cluster-api-provider-cloudstack-v0.4.5.tar.gz
