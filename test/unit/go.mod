module sigs.k8s.io/cluster-api-provider-cloudstack/test/unit
...
require (
	...
	sigs.k8s.io/cluster-api-provider-cloudstack v0.4.3
	sigs.k8s.io/controller-runtime v0.11.1
)

replace sigs.k8s.io/cluster-api-provider-cloudstack => ../../
