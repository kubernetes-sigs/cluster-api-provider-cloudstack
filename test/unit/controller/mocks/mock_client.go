...
func (m *MockClient) AddClusterTag(arg0 cloud.ResourceType, arg1 string, arg2 *v1beta1.CloudStackCluster) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) AssignVMToLoadBalancerRule(arg0 *v1beta1.CloudStackIsolatedNetwork, arg1 string) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) AssociatePublicIPAddress(arg0 *v1beta1.CloudStackZone, arg1 *v1beta1.CloudStackIsolatedNetwork, arg2 *v1beta1.CloudStackCluster) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) DeleteClusterTag(arg0 cloud.ResourceType, arg1 string, arg2 *v1beta1.CloudStackCluster) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) DeleteNetwork(arg0 v1beta1.Network) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) DisassociateAffinityGroup(arg0 *v1beta1.CloudStackMachine, arg1 cloud.AffinityGroup) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) DisposeIsoNetResources(arg0 *v1beta1.CloudStackZone, arg1 *v1beta1.CloudStackIsolatedNetwork, arg2 *v1beta1.CloudStackCluster) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetOrCreateIsolatedNetwork(arg0 *v1beta1.CloudStackZone, arg1 *v1beta1.CloudStackIsolatedNetwork, arg2 *v1beta1.CloudStackCluster) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetOrCreateLoadBalancerRule(arg0 *v1beta1.CloudStackZone, arg1 *v1beta1.CloudStackIsolatedNetwork, arg2 *v1beta1.CloudStackCluster) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetOrCreateVMInstance(arg0 *v1beta1.CloudStackMachine, arg1 *v1beta10.Machine, arg2 *v1beta1.CloudStackCluster, arg3 *v1beta1.CloudStackZone, arg4 *v1beta1.CloudStackAffinityGroup, arg5 string) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPublicIP(arg0 *v1beta1.CloudStackZone, arg1 *v1beta1.CloudStackIsolatedNetwork, arg2 *v1beta1.CloudStackCluster) (*cloudstack.PublicIpAddress, error) {
	m.ctrl.T.Helper()
...
// NewClientFromSpec mocks base method.
func (m *MockClient) NewClientFromSpec(arg0 cloud.Config) (cloud.Client, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewClientFromSpec", arg0)
	ret0, _ := ret[0].(cloud.Client)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// NewClientFromSpec indicates an expected call of NewClientFromSpec.
func (mr *MockClientMockRecorder) NewClientFromSpec(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewClientFromSpec", reflect.TypeOf((*MockClient)(nil).NewClientFromSpec), arg0)
}

// OpenFirewallRules mocks base method.
func (m *MockClient) OpenFirewallRules(arg0 *v1beta1.CloudStackIsolatedNetwork) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) ResolveLoadBalancerRuleDetails(arg0 *v1beta1.CloudStackZone, arg1 *v1beta1.CloudStackIsolatedNetwork, arg2 *v1beta1.CloudStackCluster) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) ResolveNetwork(arg0 *v1beta1.Network) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) ResolveNetworkForZone(arg0 *v1beta1.CloudStackZone) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) ResolveZone(arg0 *v1beta1.CloudStackZone) error {
	m.ctrl.T.Helper()
