...
func NetworkWithCustomOfferingSpec(ctx context.Context, inputGetter func() CommonSpecInput) {
	...
	BeforeEach(func() {
		...
		networkOfferingName = input.E2EConfig.MustGetVariable(CustomNetworkOfferingWithEgressPolicyName)
		networkName = input.E2EConfig.MustGetVariable(NetworkNameWithCustomOffering)
