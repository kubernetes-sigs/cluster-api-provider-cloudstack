...
// ComplexClusterSpec implements a test that verifies that an app deployed to the workload cluster works.
func ComplexClusterSpec(ctx context.Context, inputGetter func() CommonSpecInput) {
	var (
		specName                  = "complex-cluster"
	...
	It("Should be able to create the complex cluster", func() {
